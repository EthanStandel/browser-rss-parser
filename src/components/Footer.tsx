    ...
    <div className="footer-container">
      ...
      <section className="footer-legal">
        <div className="websiteInfo">
          ...
          <p className="footnote inline"><em>nuntii</em> n'est affilié ni à <a href="https://www.apple.com" target="_blank" rel="noreferrer">Apple</a>, ni à une quelconque rédaction.</p>
        </div>
        <nav className="mini-links c1 bold">
          <a href="mailto:clement.krajecki@gmail.com?subject=nuntii&body=Bonjour!">Contact</a>
