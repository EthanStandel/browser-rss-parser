...
const IdeesComponent = () => {
  return (
    Disc(<h5>Les rendez-vous avec les idées</h5>,<ul className='rss nList nListInblock' dangerouslySetInnerHTML={{ __html: jsonToListDisc(IdeesEntries)}} />,"Idees",IdeesEntries.length,"discIDBlock")
  );
}
